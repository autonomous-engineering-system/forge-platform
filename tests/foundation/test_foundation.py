...
REQUIRED = (
    ...
    "docs/development/COMPOSITION_CATALOG_RELEASE.md",
    ...
    ".github/workflows/forge-platform-composition-catalog-release.yml",
    "installer-version.json",
    "installer-release-identity.json",
    "release-trust/ForgePlatformInstallerReleaseTrust.json",
    ...
    "scripts/run_local_composition_catalog_release.sh",
