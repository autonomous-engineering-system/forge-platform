...
record is also implemented; its publisher and live gate observers are not. The
live Git and Python OS observer/mutation routes, signed helper registration and
released wiring remain outside the implemented boundary.
...
publisher and live gate observers, signed helper registration and released
journal-seeding integration remain unimplemented.
...
gate observers, gate publisher, signed service registration and released wiring
remain unimplemented. A descriptor-safe reader for their fixed canonical
complete record is implemented.
