...
implemented; its live OS observer/mutation route, concrete Python and gate
...
mutation route, concrete Python and gate adapters, signed helper registration
and released journal-seeding integration remain unimplemented.
...
decorator are implemented. The live managed-Git OS observer and mutation route,
