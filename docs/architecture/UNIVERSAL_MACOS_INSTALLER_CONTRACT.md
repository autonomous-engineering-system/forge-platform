...
are also implemented. The live gate observers, live Git and Python OS
...
durable readback of the complete set. Live gate observers, signed helper
registration and released journal-seeding integration remain unimplemented.
...
gate observers, signed service registration and released wiring remain
unimplemented. A descriptor-safe reader, atomic publisher and complete-set exact
