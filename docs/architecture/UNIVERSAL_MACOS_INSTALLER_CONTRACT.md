...
reader, publisher and exact durable-readback coordinator are implemented.
Actual OS-backed Git, Python and gate source adapters, signed helper
...
fixed NSXPC boundaries, locked capturer, fixed-file host-state reader and
atomic publisher with exact durable readback are implemented. Actual OS-backed
Git, Python and gate source adapters, signed helper registration and released
...
durable readback. Actual OS-backed Git, Python and gate source adapters, signed
service registration and released wiring remain unimplemented.
