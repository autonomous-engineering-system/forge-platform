...
terminal receipt. The concrete fresh replanner, atomic parent-journal store and
...
seam. The concrete fresh replanner, atomic file-backed journal implementation
