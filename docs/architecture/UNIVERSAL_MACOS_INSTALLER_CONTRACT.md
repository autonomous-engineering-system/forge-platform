...
and closed runtime-slot mutation coordinator. It ships no concrete privileged
adapter or runtime bytes, and it is not wired to the released native installer.
